...
English: Execution summary for all jobs in the cell-culture run. Columns: reservation_time (time scheduling was performed; tentative under dynamic scheduling), optimal_start_time, scheduled_time, execution_start_time, processing_time, experiment_operation, experiment_uuid.
